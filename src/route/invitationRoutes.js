...
invitationRoutes.post('/friend/create/:id', SendInvitation);    // Send friend request
invitationRoutes.get('/friend/:id', GetAllRequest);             // Get friend requests (sent & received)
invitationRoutes.delete('/friend/:id', DeleteInvitation);       // Accept/Reject/Withdraw friend request
